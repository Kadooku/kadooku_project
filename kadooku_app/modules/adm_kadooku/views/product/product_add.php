                    ...
                    <?php for ($i=1; $i <=3 ; $i++) :?>
                        <div class="col-md-4 col-sm-4 col-xs-4">
                            <div class="form-group text-center">
                                <div id="upload-<?=$i;?>">
                                    <div id="thumbnail-<?=$i;?>">
                                        <img class="img-responsive img-rounded img-thumbnail" width="180" height="240" src="<?php echo base_url('kadooku_uploads/product/img/default.jpg');?>"/>
                                    </div>
                                </div>
                            ...
                            <?php
                                foreach ($categories as $c) {
                                    ...
                                    if($sub_menu->num_rows() > 0){
                                        echo "<optgroup label='$c->category_name'>";
