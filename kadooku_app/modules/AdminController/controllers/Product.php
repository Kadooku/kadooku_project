...
class Product extends CI_Controller {
    ...
    {
        $this->template->load('backend/template', 'product/product_view');
    }
    ...
    public function add()
    {
        ...
        $this->template->load('backend/template', 'product/product_add', $data);
	}
    ...
    public function edit($id = null)
    {
		...
		if($id != null && $getProduct->num_rows() > 0){
			...
			$this->template->load('backend/template', 'product/product_edit', $data);
		}
        else{
			$message = array(
