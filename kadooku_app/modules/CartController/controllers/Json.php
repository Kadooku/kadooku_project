...
class Json extends CI_Controller {
    ...
    public function getAddress()
    {
        ...
        $table        = 'list_logistics';
        $add          = $this->CartModel->getAddressById($address_id);
        $getLogistics = $this->JsonModel->getJsonItem($table, array('kota_kabupaten LIKE' => "%".$add->regency."%", 'kecamatan LIKE' => "%".$add->district."%"));
